...
#include "common/simulink_foc/SimulinkFOCAdapterStepper.h"
...
class StepperMotor: public FOCMotor
{
  ...
  /**
    ...
    */
     ...
     */
    SimulinkFOCAdapterStepper& getSimulinkFOCAdapter() { return simulink_foc_adapter_; }
  ...
  private:
    ...
    SimulinkFOCAdapterStepper simulink_foc_adapter_;
